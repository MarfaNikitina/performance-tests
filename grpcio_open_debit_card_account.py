...
from contracts.services.gateway.accounts.rpc_open_debit_card_account_pb2 import OpenDebitCardAccountResponse, OpenDebitCardAccountRequest
...
# Формируем запрос на открытие дебетового счета для пользователя
